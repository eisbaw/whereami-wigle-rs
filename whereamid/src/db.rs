...
// task-0055: Source enum extracted to db/source.rs. Public API
// re-exported here so existing call sites (`crate::db::Source`) keep
// working unchanged.
mod source;
...
mod tests {
    ...
    // source_priority_ladder test moved to db/source.rs alongside the enum.
