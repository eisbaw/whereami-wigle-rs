...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Architecture diagram is current as of v0.4.0 (shows history, last_fix persistence, address cache, in-flight dedup)
- [ ] #2 Diagram source format makes future regeneration tractable (text-art preferred; if SVG, the source file is committed and a 'just diagram' recipe regenerates it)
<!-- AC:END -->
